...
public class AllegroWebApiServiceLocator extends org.apache.axis.client.Service implements com.allegro.webapi.AllegroWebApiService {
    ...
    private java.lang.String AllegroWebApiPort_address = "https://webapi.allegro.pl/uploader.php";
    ...
    public com.allegro.webapi.AllegroWebApiPortType getAllegroWebApiPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.allegro.webapi.AllegroWebApiPortType getAllegroWebApiPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.allegro.webapi.AllegroWebApiBindingStub _stub = new com.allegro.webapi.AllegroWebApiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.allegro.webapi.AllegroWebApiPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.allegro.webapi.AllegroWebApiBindingStub _stub = new com.allegro.webapi.AllegroWebApiBindingStub(new java.net.URL(AllegroWebApiPort_address), this);
                _stub.setPortName(getAllegroWebApiPortWSDDServiceName());
                return _stub;
            }
        }
