...
public class DoGetMyWatchItemsResponse  implements java.io.Serializable {
    ...
    private com.allegro.webapi.ArrayOfWatchitemstruct watchItemsList;
    ...
    public DoGetMyWatchItemsResponse(
           ...
           com.allegro.webapi.ArrayOfWatchitemstruct watchItemsList) {
     ...
     */
    public com.allegro.webapi.ArrayOfWatchitemstruct getWatchItemsList() {
        return watchItemsList;
    }
     ...
     */
    public void setWatchItemsList(com.allegro.webapi.ArrayOfWatchitemstruct watchItemsList) {
        this.watchItemsList = watchItemsList;
    }
        ...
        _equals = true && 
            ...
            ((this.watchItemsList==null && other.getWatchItemsList()==null) || 
             (this.watchItemsList!=null &&
              this.watchItemsList.equals(other.getWatchItemsList())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getWatchItemsList() != null) {
            _hashCode += getWatchItemsList().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfWatchitemstruct"));
