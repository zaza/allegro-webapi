...
public class WatchItemStruct  implements java.io.Serializable {
    ...
    private com.allegro.webapi.ArrayOfItemreminderstruct itemReminder;
    ...
    public WatchItemStruct(
           ...
           int itemPayuInfo,
           com.allegro.webapi.ArrayOfItemreminderstruct itemReminder) {
           this.itemId = itemId;
     ...
     * @return itemReminder
     */
    public com.allegro.webapi.ArrayOfItemreminderstruct getItemReminder() {
        return itemReminder;
    }
     ...
     * @param itemReminder
     */
    public void setItemReminder(com.allegro.webapi.ArrayOfItemreminderstruct itemReminder) {
        this.itemReminder = itemReminder;
    }
        ...
        _equals = true && 
            ...
            ((this.itemReminder==null && other.getItemReminder()==null) || 
             (this.itemReminder!=null &&
              this.itemReminder.equals(other.getItemReminder())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getItemReminder() != null) {
            _hashCode += getItemReminder().hashCode();
        }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://webapi.allegro.pl/service.php", "ArrayOfItemreminderstruct"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
