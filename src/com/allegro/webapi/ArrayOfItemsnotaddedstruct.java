...
public class ArrayOfItemsnotaddedstruct  implements java.io.Serializable {
    private com.allegro.webapi.ItemsNotAddedStruct[] item;

    public ArrayOfItemsnotaddedstruct() {
    }

    public ArrayOfItemsnotaddedstruct(
           com.allegro.webapi.ItemsNotAddedStruct[] item) {
           this.item = item;
    }
     ...
     * @return item
     */
    public com.allegro.webapi.ItemsNotAddedStruct[] getItem() {
        return item;
    }
     ...
     * @param item
     */
    public void setItem(com.allegro.webapi.ItemsNotAddedStruct[] item) {
        this.item = item;
    }

    public com.allegro.webapi.ItemsNotAddedStruct getItem(int i) {
        return this.item[i];
    }

    public void setItem(int i, com.allegro.webapi.ItemsNotAddedStruct _value) {
        this.item[i] = _value;
    }
