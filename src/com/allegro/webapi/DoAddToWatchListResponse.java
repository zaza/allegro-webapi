...
public class DoAddToWatchListResponse  implements java.io.Serializable {
    private com.allegro.webapi.WatchListInfoStruct watchListInfo;

    public DoAddToWatchListResponse() {
    }

    public DoAddToWatchListResponse(
           com.allegro.webapi.WatchListInfoStruct watchListInfo) {
     ...
     */
    public com.allegro.webapi.WatchListInfoStruct getWatchListInfo() {
        return watchListInfo;
    }
     ...
     * @param watchListInfo
     */
    public void setWatchListInfo(com.allegro.webapi.WatchListInfoStruct watchListInfo) {
        this.watchListInfo = watchListInfo;
    }
